...
class MainWindow(QMainWindow):
    ...
    def _build_toolbar(self):
        ...
        self.hl2_telem_label.setToolTip(
            ...
            "PA — combined push-pull PA bias/drain current (A),\n"
            "    the HL2 12-bit bias-current ADC.  ~0.2 A at idle\n"
            "    bias, ~1.8 A at full tune into a dummy.  The\n"
            "    Phase-3-EXIT kill-test observable: must drop back\n"
            "    toward idle within a few seconds of Lyra being\n"
            "    force-killed mid-TX (the HL2 gateware watchdog).\n\n"
